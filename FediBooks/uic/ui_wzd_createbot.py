...
class Ui_wzdCreateBot(object):
	def setupUi(self, wzdCreateBot):
		...
		self.stk_main.addWidget(self.page)
	...
	def retranslateUi(self, wzdCreateBot):
		...
		self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), QtWidgets.QApplication.translate("wzdCreateBot", "Markov (\"Ebooks bot\")", None, -1))
		...
		self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), QtWidgets.QApplication.translate("wzdCreateBot", "Command output", None, -1))
		self.label_33.setText(QtWidgets.QApplication.translate("wzdCreateBot", "<html><head/><body><p>Choose this option to leave the bot without any rules for now. It won\'t be capable of posting or replying.</p><p>You probably don\'t want to do this.</p></body></html>", None, -1))
		self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), QtWidgets.QApplication.translate("wzdCreateBot", "Blank (Advanced)", None, -1))
