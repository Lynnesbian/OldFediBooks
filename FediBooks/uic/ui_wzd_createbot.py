...
class Ui_wzdCreateBot(object):
    def setupUi(self, wzdCreateBot):
        ...
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL("pressed()"), wzdCreateBot.btn_cancel_pressed)
        QtCore.QObject.connect(self.pushButton_13, QtCore.SIGNAL("pressed()"), wzdCreateBot.btn_help_pressed)
        QtCore.QObject.connect(self.pushButton_3, QtCore.SIGNAL("pressed()"), wzdCreateBot.btn_back_pressed)
        QtCore.QObject.connect(self.pushButton_2, QtCore.SIGNAL("pressed()"), wzdCreateBot.btn_next_pressed)
    ...
    def retranslateUi(self, wzdCreateBot):
        ...
        self.pushButton.setText(QtWidgets.QApplication.translate("wzdCreateBot", "Cancel", None, -1))
        self.pushButton_13.setText(QtWidgets.QApplication.translate("wzdCreateBot", "Help", None, -1))
        self.pushButton_3.setText(QtWidgets.QApplication.translate("wzdCreateBot", "Back", None, -1))
        self.pushButton_2.setText(QtWidgets.QApplication.translate("wzdCreateBot", "Next", None, -1))
