...
# Form implementation generated from reading ui file 'FediBooks/gui/botoverview.ui',
# licensing of 'FediBooks/gui/botoverview.ui' applies.
#
...
class Ui_MainWindow(object):
	...
	def retranslateUi(self, MainWindow):
		...
		self.label_2.setText(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>[bot name] is <span style=\" font-weight:600;\">active</span>, and replies are <span style=\" font-weight:600;\">enabled</span>. Its most recent post was 12 minutes ago.</p><p>There are <span style=\" font-weight:600;\">0</span> posting rulesets, and <span style=\" font-weight:600;\">0</span> reply rulesets.</p></body></html>", None, -1))
		self.pushButton_5.setText(QtWidgets.QApplication.translate("MainWindow", "Deactivate", None, -1))
		self.pushButton_7.setText(QtWidgets.QApplication.translate("MainWindow", "Specify rules (Advanced)", None, -1))
		...
		self.label_5.setText(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>Your bot is currently learning from <span style=\" font-weight:600;\">1</span> source. However, your bot has <span style=\" font-weight:600;\">no rules that use the Markov engine</span>, which means these sources aren\'t currently being used.</p></body></html>", None, -1))
		...
		self.label_3.setText(QtWidgets.QApplication.translate("MainWindow", "<html><head/><body><p>The database your bot uses to post contains <span style=\" font-weight:600;\">0</span> entries. This is below the recommended minimum of <span style=\" font-weight:600;\">100</span>. Your bot may fail to post, or post repetitive content. The FediBooks database, which stores data for all the bots as well as configuration for FediBooks itself, is <span style=\" font-weight:600;\">32KiB</span> in size.</p></body></html>", None, -1))
